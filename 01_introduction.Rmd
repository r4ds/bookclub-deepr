...
- Run R in **interactive**, **batch mode** and **semi-interactive**

- Create, import and work with one of the basic data type: **numeric vector**
...
He advocates for an approach that could help us solving every data intense problem and acquire skills relevant to other language. 
